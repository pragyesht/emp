    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Master Emp Edit</h3>
            </div>
			<?php echo form_open('master_emp/edit/'.$master_emp['me_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						<label for="me_fname" class="control-label"><span class="text-danger">*</span>Fname</label>
						<div class="form-group">
							<input type="text" name="me_fname" value="<?php echo ($this->input->post('me_fname') ? $this->input->post('me_fname') : $master_emp['me_fname']); ?>" class="form-control" id="me_fname" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="me_lname" value="<?php echo ($this->input->post('me_lname') ? $this->input->post('me_lname') : $master_emp['me_lname']); ?>" class="form-control" id="me_lname" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="me_email" value="<?php echo ($this->input->post('me_email') ? $this->input->post('me_email') : $master_emp['me_email']); ?>" class="form-control" id="me_email" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="me_mobile" value="<?php echo ($this->input->post('me_mobile') ? $this->input->post('me_mobile') : $master_emp['me_mobile']); ?>" class="form-control" id="me_mobile" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="me_salary" value="<?php echo ($this->input->post('me_salary') ? $this->input->post('me_salary') : $master_emp['me_salary']); ?>" class="form-control" id="me_salary" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="me_company" value="<?php echo ($this->input->post('me_company') ? $this->input->post('me_company') : $master_emp['me_company']); ?>" class="form-control" id="me_company" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="me_dept_id" class="form-control">
								...
								{
									$selected = ($value == $master_emp['me_dept_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="me_country" class="form-control">
								...
								{
									$selected = ($value == $master_emp['me_country']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="me_state" class="form-control">
								...
								{
									$selected = ($value == $master_emp['me_state']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="me_city" class="form-control">
								...
								{
									$selected = ($value == $master_emp['me_city']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="radio">
							  <label><input type="radio" value="Male" name="me_gender" <?php echo ($master_emp['me_gender']=='Male' ? 'checked="checked"' : ''); ?>>Male</label> &nbsp;
							  <label><input type="radio" value="Female" name="me_gender" <?php echo ($master_emp['me_gender']=='Female' ? 'checked="checked"' : ''); ?>>Female</label>
							</div>
						</div>
					</div>
